...
const margin0 = { top: 50, right: 0, bottom: 0, left: 10 };
const width0 = 1000;
const height0 = 180;
...
const disaster = [
  { id: "Tropical Cyclone", count: 67 },
  { id: "Severe Storm", count: 203 },
  { id: "Drought", count: 32 },
  { id: "Flooding", count: 45 },
  { id: "Wildfire", count: 23 },
  { id: "Winter Storm", count: 24 },
];

console.log(disaster);

const data0 = d3.csv("./data/violin.csv", d3.autoType).then(function (data0) {
  ...
  const y = d3.scaleLinear().domain([0, 170000]).range([0, innerheight0]);
  ...
  disaster.forEach((disaster) => {
    const disasterContainer = innerChart0.append("g");
