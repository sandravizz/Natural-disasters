...
const margin00 = { top: 30, right: 0, bottom: 0, left: 0 };
const width00 = 1000;
const height00 = 250;
...
const data00 = d3.csv("./data/violin.csv", d3.autoType).then(function (data00) {
  ...
  const Container = innerChart00.append("g");
  ...
  Container.append("path").attr("d", areaGenerator(bins)).attr("fill", "white");
  ...
  innerChart00
    .append("text")
    .attr("class", "text")
    .text("395 natural disasters (all types)")
